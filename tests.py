...
def move():
    ...
    angle_noabs = math.atan2(dy,dx) # in radians
    ...
    particle.position = (new_x_noabs, new_y_noabs)

    print(f'particle = {particle.position} , food = {food.position}')
for i in range(100):
    move()
# for food in arena.foods:
#     print(food.position, food.nutrition)
